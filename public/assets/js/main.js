...
function makeInviteButton(socket_id) {
    ...
    newNode.click( () => {
        ...
        console.log( '**** Client log message, sendind \'invite\' command: ' + JSON.stringify(payload));
...
function makeInvitedButton(socket_id) {
    ...
    newNode.click( () => {
        ...
        console.log( '**** Client log message, sendind \'uninvite\' command: ' + JSON.stringify(payload));
...
function makePlayButton(socket_id) { 
    ...
    newNode.click( () => {
        ...
        console.log( '**** Client log message, sendind \'game_start\' command: ' + JSON.stringify(payload));
...
socket.on('join_room_response', (payload) =>{
    ...
    /*if we are being notified our ourselves the ignore the message and return */
